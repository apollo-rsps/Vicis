 ...
 * <p>
 * Unlike CS2, legacy client scripts operate using a very simple register-based VM, with four registers:
 * <ul>
 ...
 * <li>The sole general purpose register, which contains the result of the evaluation of the current instruction, and
 * will modify the current value stored in the value register using the operator type held in the operator register.</li>
 * </ul>
 * 
 * @author Major
 */
