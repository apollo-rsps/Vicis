...
/**
 * A simple stack of `int`s, implemented specifically to avoid the boxing overhead from generic types.
 *
 * @param capacity The initial capacity of the stack.
 */
class IntStack(capacity: Int = StackConstants.DEFAULT_SIZE) {
     ...
     * The stack of `int`s.
     */
    private var stack: IntArray = IntArray(capacity)

    /**
     * The size of this IntStack.
     */
    val size: Int
        get() {
            return pointer
    ...
    override fun toString(): String {
        return "IntStack(pointer=$pointer, stack=${Arrays.toString(stack)})"
    }
