...
class ResizableBorderPane : BorderPane() {
    ...
    private val sides = listOf(leftSide, rightSide, bottomSide)
    ...
    init {
        leftProperty().onChange { node -> node?.styleClass?.add("left") }
        rightProperty().onChange { node -> node?.styleClass?.add("right") }
        topProperty().onChange { node -> node?.styleClass?.add("top") }
        bottomProperty().onChange { node -> node?.styleClass?.add("bottom") }
