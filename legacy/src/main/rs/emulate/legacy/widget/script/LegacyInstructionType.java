...
/**
 * An instruction used in a {@link LegacyClientScript}.
 *
 * @author Major
 */
public enum LegacyInstructionType { // TODO these doc comments suck
	 ...
	 * <p>
	 * Example: {@code mov_curr_lvl 0} moves the current level of the Attack skill into the accumulator.
	 */
	 ...
	 * <p>
	 * Example: {@code mov_max_lvl 0} moves the maximum level of the Attack skill into the accumulator.
	 */
	 ...
	 * <p>
	 * Example: {@code mov_exp 0} moves the experience of the Attack skill into the accumulator.
	 */
	 ...
	 * <p>
	 * Example: {@code mov_item_amnt 10, 995} moves the amount of coins in the inventory of widget 10 into the
	 * accumulator.
	 */
	 ...
	 * register.
	 * <p>
	 * Example {@code mov_exp_lvl 99} moves 13,034,431 into the accumulator.
	 */
	 ...
	 * <p>
	 * Example: {@code mov_max_amnt 10, 995} moves 999,999,999 into the accumulator if the inventory of widget 10
	 ...
	 * <p>
	 * Example: {@code mov 42} moves 42 into the accumulator.
	 */
	 ...
	 */
	public static LegacyInstructionType forMnemonic(String mnemonic) {
		return Arrays.stream(values()).filter(instruction -> mnemonic.equals(instruction.mnemonic)).findFirst()
				.orElseThrow(() -> new IllegalArgumentException("No instruction with the specified integer value exists."));
	}
	 ...
	 * @throws IllegalArgumentException If no LegacyInstructionType with the specified integer value exists.
	 */
	public static LegacyInstructionType valueOf(int value) {
		return Arrays.stream(values()).filter(instruction -> instruction.value == value).findFirst()
				.orElseThrow(() -> new IllegalArgumentException("No instruction with the specified integer value exists."));
	}

	/**
	 * The mnemonic of this LegacyInstructionType.
	 */
	private final String mnemonic;

	/**
	 * The operand count of this LegacyInstructionType.
	 */
	private final int operands;

	/**
	 * The integer value of this LegacyInstructionType.
	 */
	private final int value;

	/**
	 * Creates the LegacyInstructionType.
	 *
	 * @param value The integer value of the LegacyInstructionType.
	 * @param mnemonic The mnemonic of the LegacyInstructionType.
	 * @param operands The operand count of the LegacyInstructionType.
	 */
	private LegacyInstructionType(int value, String mnemonic, int operands) {
		this.value = value;
	...
	/**
	 * Gets the mnemonic of this LegacyInstructionType.
	 *
	 * @return The mnemonic.
	 */
	...
	/**
	 * Gets the operand count of this LegacyInstructionType.
	 *
