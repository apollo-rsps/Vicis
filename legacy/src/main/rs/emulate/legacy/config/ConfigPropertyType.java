...
/**
 * A {@link PropertyType} used as part of the {@link ConfigEncoder} and {@link ConfigDecoder}, {@link #opcode()}.
 * Should
 * <strong>only</strong> be implemented by enumerators (excluding the existing {@link DynamicConfigPropertyType}
 * class).
 *
 * @author Major
 */
