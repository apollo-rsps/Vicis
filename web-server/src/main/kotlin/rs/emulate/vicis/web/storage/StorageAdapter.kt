...
object DataConflict : StorageError()
...
interface StorageAdapter<IdT, EntityT> : AutoCloseable {
    ...
    fun putAll(entities: List<EntityT>, token: StorageCacheToken): Result<Unit, StorageError>
    fun put(entity: EntityT, token: StorageCacheToken):  Result<Unit, StorageError>
    fun flush()
